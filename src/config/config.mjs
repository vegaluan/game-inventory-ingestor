...
export const STEAM_API_GET_ASSETS = STEAM_API_BASEURL.concat(STEAM_API_PATH_GET_ASSET_PRICES);
export const STEAM_API_GET_ASSET_NAME = STEAM_API_BASEURL.concat(STEAM_API_PATH_GET_ASSET_NAME);
